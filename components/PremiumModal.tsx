      ...
      <div className="relative w-full max-w-md bg-slate-900 rounded-t-3xl sm:rounded-3xl overflow-hidden border-t border-slate-700 shadow-2xl transform transition-transform duration-300 animate-in slide-in-from-bottom">
        ...
        <div className="p-6">
            ...
            <Button 
                fullWidth 
                size="lg" 
                className="bg-gradient-to-r from-yellow-500 to-orange-600 hover:from-yellow-400 hover:to-orange-500 text-slate-900 font-black shadow-lg shadow-orange-500/20"
                onClick={() => alert('Implementace platební brány (Stripe/Apple Pay)')}
            >
                AKTIVOVAT GOLD
            </Button>
